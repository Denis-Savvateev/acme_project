...
ALLOWED_HOSTS = [
    ...
    # в этот список нужно будет добавить и адреса домена, где он
    # будет размещён, например 'acme.not' и 'www.acme.not'
]
...
# Эта константа установлена, чтобы DjDT (debug toolbar) знал,
